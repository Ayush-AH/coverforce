"use client";
import { useRef, useEffect, useCallback, useState, JSX, type MutableRefObject } from "react";
  ...
  return (
    <TooltipProvider delayDuration={400}>
      <motion.div
        ...
        className="absolute bottom-3 left-1/2 z-50 flex -translate-x-1/2 items-end"
        style={{
          ...
          boxShadow:
            "0 0 0 0.5px rgba(0,0,0,0.18), 0 10px 36px rgba(0,0,0,0.38), inset 0 1px 0 rgba(255,255,255,0.14)",
        }}
      >
        {apps.map((a, i) => (
          <MagnifiedDockIcon
