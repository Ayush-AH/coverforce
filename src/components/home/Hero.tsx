        ...
        <div className="relative z-10 flex min-h-[calc(100svh-4.5rem)] flex-col justify-between py-16 md:min-h-[calc(100svh-5rem)] md:py-20 lg:py-24">
          <div className="flex flex-1 flex-col items-center justify-center text-center">
            ...
            <div className="mt-10 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-center">
              ...
              <Link
                href="/"
                className="inline-flex items-center justify-center rounded-full border border-white/40 bg-white/5 px-8 py-3.5 text-xs font-semibold uppercase tracking-[0.08em] text-white backdrop-blur-sm transition-colors hover:border-white hover:bg-white/10"
              >
                Start a quote
              </Link>
            </div>
