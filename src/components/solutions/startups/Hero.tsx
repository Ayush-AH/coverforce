      ...
      <Container borderColor="#53535380">
        <div className="grid h-screen grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-16">
          <div className="flex flex-col justify-center space-y-8">
            <h1 className="max-w-xl text-3xl font-heading font-medium leading-[1.12] tracking-tight text-[#0a143b] md:text-4xl lg:text-6xl lg:leading-[1.1]">
              Standardise <br/> commercial lines <br/> everywhere.
            </h1>
