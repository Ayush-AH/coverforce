      ...
      <Container>
        <div className="relative flex items-center justify-between py-4 md:py-6">
            ...
            <ul className="pointer-events-auto flex items-center gap-6 xl:gap-8">
              {navItems.map(({ label, href, hasDropdown }) => (
                <li key={label}>
                  <Link
                    href={href}
                    className="flex items-center gap-1 font-mono text-sm font-regular uppercase tracking-[0.12em] text-white/95 transition-colors hover:text-white"
                  >
                    {label}
                    {hasDropdown && (
                      <RiArrowDownSLine
          ...
          <div className="relative z-10 hidden items-center gap-6 lg:flex xl:gap-8">
            <Link
              href="/"
              className="font-mono text-sm font-medium uppercase tracking-[0.12em] text-white/95 transition-colors hover:text-white"
            >
              Login
            </Link>
